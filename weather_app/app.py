...
def home():
    ...
    try:
        ...
        sunrise = "--"
        sunset = "--"
    return render_template("home.html",place = search,description=description,temperature=main_temp,feel_like = feel_like,max=max,min=min,press=press,hum=hum,ws=ws,r=r,sunrise=sunrise,sunset=sunset)
